...
export const cartApi = {
  uploadCart: (data, token) =>
    api.post("product/cart", data, { headers: { Authorization: token } }),
  getCartItems: (token) =>
    api.get("product/cart", { headers: { Authorization: token } }),
  deleteCartItems: (token, itemId) =>
    api.delete(`/product/cart/${itemId}`, {
