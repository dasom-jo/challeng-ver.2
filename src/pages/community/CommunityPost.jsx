    ...
    <>
      ...
      <section className={styles.notice}>
        <div>
          ...
          <div className={styles.paramTitle2}>{params.title}</div>
        </div>
            ...
            <table className={styles.boardTable}>
              <thead>
                <tr>
                  ...
                  <th scope="col" className={styles.thwriter}>
                    작성자
                  </th>
              ...
              <tbody>
                {posts &&
                  posts
                    .slice(
                      SHOW_POST_NUM * (curPage - 1),
                      SHOW_POST_NUM * curPage,
                    )
                    .map((p) => {
                      return (
                        <tr
                          className={styles.post}
                          onClick={() => handleClickOpenPost(p)}
                        >
                          <td className={styles.postLike}>
                            {" "}
                            {p.Likers ? p.Likers.length : 0}
                          </td>
                          <th className={styles.postTitle}>
                            {p.title}
                            <span className={styles.commentColor}>
