  ...
  return (
    <div>
      ...
      <div className={myInfo.MyInfo}>
        <div className={myInfo.text1} onClick={() => navigation("/")}>
          challen.gg
        </div>
        <div className={myInfo.text2}>MY PAGE</div>
          ...
          <div className={myInfo.MyInfos}>
            ...
            <form onSubmit={uploadProfileImg}>
              ...
              {change ? (
                ...
                <label htmlFor="fileInput" className={myInfo.ProfileText}>
                  프로필을 변경할까요?
                </label>
              )}
            </form>
            ...
            {/* 닉네임 */}
            {userProfile ? (
              <span className={myInfo.Nick}>{userProfile.nickname}</span>
            ) : (
              <p>Loading...</p>
            )}
            {/* 닉네임변경버튼 */}
        ...
        <div className={myInfo.FollowAndChallenge}>
          <div>
            {/* 팔로우팔로잉버튼 */}
            {userProfile && <Follow user={userProfile} />}
          </div>
