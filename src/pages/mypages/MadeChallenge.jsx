...
const MadeChallenge = () => {
  ...
  return (
    <div>
      <MadeChallengeModal isOpen={isOpen} CloseModal={CloseModal} />
      <button className={myButtons.MadeChallenge} onClick={OpenModal}>
        챌린지개설
      </button>
    </div>
  );
    ...
    <div>
      ...
      >
        ...
        <div className={madeChallenge.image}>
          <label htmlFor={madeChallenge.mainImg} id={madeChallenge.Click}>
            이미지 등록하기 click!
          </label>
          <input
            type="file"
            onChange={handleImageUpload}
            id={madeChallenge.mainImg}
          ></input>
          {imagePreview && (
