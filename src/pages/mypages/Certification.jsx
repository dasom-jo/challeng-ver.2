...
const Certification = () => {
  ...
  return (
    <>
      <button className={challengeCertification.AuthButton} onClick={open}>
        인증
      </button>
        ...
        <div className={challengeCertification.modalBody}>
          ...
          {preImg ? (
            <img
              src={preImg}
              alt="나의 인증 이미지"
              style={{ width: "318px", height: "318px", margin: "10px" }}
            />
          ) : (
            ""
          )}
          ...
          <div className={challengeCertification.challengeList}>
            {showChallengeList.map(
              (item) =>
                item.SuccessId === challengeItem.id && (
                  <div
                    key={item.id}
                    className={challengeCertification.CertificationList}
                  >
